...
export const financialControlKpis: Record<CadenceType, KpiDefinition[]> = {
  daily: [
    { key: 'net_cash_flow', label: 'Net Cash Flow', icon: DollarSign, format: 'currency', trendLabel: 'today' },
  ...
  weekly: [
    { key: 'net_cash_flow', label: 'Net Cash Flow', icon: DollarSign, format: 'currency', trendLabel: 'this week' },
  ...
  monthly: [
    { key: 'net_cash_flow', label: 'Net Cash Flow', icon: DollarSign, format: 'currency', trendLabel: 'this month' },
  ...
  quarterly: [
    { key: 'net_cash_flow', label: 'Net Cash Flow', icon: DollarSign, format: 'currency', trendLabel: 'this quarter' },
